/*
    ...
    Usage:
        ...
        3) Instantiate the WebNotepad using the DOM ID of the DIV
            ...
            Custom configuration values can be supplied for HTML elements
            
            var editor = new WebNotepad('webnote',{
                selectorId : 'selectNoteHere',
                editorId : 'editNoteHere'
            });
...
class WebNotepad {
    constructor(id,customConfig) {
        ...
        this.config = {
            ...
            //Element containing note selector
            selectorId : 'selector',
			
            //Element containing note editor
            editorId : 'editor',
			
            //Create note button
            createNoteId : 'createnote',
			
            //Label for new note field
            ...
            //Function runs when application loads
            onload : function(notepad) { },
            
            //Function runs when a note is saved
            onsave : function(notepad) { },
        ...
        if (customConfig) {
            Object.keys(customConfig).forEach(cfg => {
                this.config[cfg] = customConfig[cfg];
            });
        }
